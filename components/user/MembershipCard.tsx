...
const vipBenefits = ["完整 AI 赛事报告", "球员深度分析", "首发预测", "市场数据变化", "AI 不确定性分析", "历史模型数据"];
