...
type MatchOverviewProps = { homeTeam: string; awayTeam: string; league: string; matchTime: string | null };
function formatTime(value: string | null) { return formatMatchDateTime(value).label; }
